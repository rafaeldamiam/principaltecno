<center>
	<h2>Administração</h2><br><br>
	<a href="./admin/quantProdutos">Listar Produtos e sua quantidade no estoque</a><br>
	<a href="./admin/prodCategoria">Listar Produtos por categoria</a><br>
